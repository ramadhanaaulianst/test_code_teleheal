...
List getRumahSakit() {
  return [
    ...
    RumahSakit(
      namaRumahSakit: "Rumah Sakit Ibu dan Anak Kemang Medical Care",
      alamatRumahSakit: "Jl. Ampera Raya No. 34 - Pasar Minggu, Jakarta Selatan, Jakarta, Indonesia 12550",
      gambarRumahSakit: "https://static.konsula.com/images/practice/0001001000/0001000157/rumah-sakit-ibu-dan-anak-kemang-medical-center.800x600.jpg",
      dataRumahSakit: "RSIA Kemang Medical Care yang terletak di Jalan Ampera Raya No. 34 Jakarta Selatan ini menyelenggarakan pelayanan kesehatan bagi masyarakat khususnya untuk kesehatan ibu dan anak. Tenaga-tenaga profesional dari RSIA Kemang Medical Care yang terdiri dari dokter dan perawat serta dukungan tenaga administrasi yang berpengalaman, sesuai dengan misi yang diusung yakni mengedepankan keamanan pasien (safety), berkualitas dalam pelayanan (quality) serta memberikan perhatian yang penuh kepada ibu dan anak (compassion). RSIA Kemang Medical Care memfokuskan pada menjaga, meningkatkan kesehatan Ibu dan Anak termasuk di dalamnya menyediakan seluruh pelayanan kesehatan yang diperlukan agar ibu dan anak tetap sehat. Pendekatan ini dikenal dengan “life cycle approach”, artinya seluruh siklus kehidupan manusia, mulai dari bayi, anak sekolah, remaja, pasangan muda, ibu hamil dan menyusui menjadi perhatian secara berkesinambungan.",
    ),
    RumahSakit(
    ...
    RumahSakit(
      namaRumahSakit: "Rumah Sakit Ibu dan Anak Brawijaya",
      alamatRumahSakit: "Jl. Taman Brawijaya II No.1 - Kebayoran Baru, Jakarta Selatan, Jakarta, Indonesia 12150",
      gambarRumahSakit: "https://static.konsula.com/images/practice/0001001000/0001000111/rumah-sakit-ibu-dan-anak-brawijaya.800x600.jpg",
      dataRumahSakit: "Rumah Sakit Ibu dan Anak Brawijaya merupakan sebuah Rumah Sakit yang berlokasi di Kebayoran Baru, Jakarta Selatan, Jakarta, Indonesia. Saat ini, dokter-dokter yang melakukan praktek di Rumah Sakit Ibu dan Anak Brawijaya diantaranya adalah dr. Ali Sungkar, Sp.OG-KFM, dr. Sander D. Teddy, Sp.A, dr. Dyah Irawati, Sp.OG, dan dokter lainnya. Adapun beberapa layanan kesehatan yang dapat Anda temukan di Rumah Sakit Ibu dan Anak Brawijaya adalah Anak, Gigi, Apotek, Praktek Bidan, Kebidanan dan Kandungan, dan lain-lain.",
    ),
    RumahSakit(
